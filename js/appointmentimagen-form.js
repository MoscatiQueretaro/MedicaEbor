...
$(document).ready(function() {
    ...
    $(".appointmentimagen-form").submit(function(e) {
        e.preventDefault();
        ...
        $.ajax({
            type: "POST",
            data: dataString,
            url: "php/appointmentFormImagen.php",
            cache: false,
            success: function (d) {
                $(".form-control").removeClass("success");
                     if(d.indexOf("success") > -1 )  // Message Sent? Show the 'Thank You' message and hide the form
                        ...
                        $('.loading').fadeIn('slow').html('<font color="#ff5607">Ocurrio un error imagen , favor de intentarlo mas tarde.</font>').delay(3000).fadeOut('slow');
                                }
        });
        return false;
    });
