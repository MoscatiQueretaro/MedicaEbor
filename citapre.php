							...
							<div class=" breadcrumb-holder">
								...
								<nav aria-label="breadcrumb">
								  	<ol class="breadcrumb">
								    	...
								    	<li class="breadcrumb-item active" aria-current="page">Preregistro</li>
								  	</ol>
								</nav>

								<!-- Title -->
								<h4 class="h4-sm darkblue-color">Solicitar Preregistro</h4>
				...
				<div class="container">
				 	<div class="row">
				 		...
				 		<div class="col-lg-8">
				 			<div class="txt-block pr-30">
				 				...
				 				<!-- Title -->
								<h3 class="h3-md darkblue-color">Preregistro</h3>

								<!-- Text -->
								<p>Para darle un mejor servicio, complete su información antes de visitar el hospital .
								</p>

								<!-- APPOINTMENT FORM -->
								<div id="appointmentpre-form-holder" class="text-center">
									<form name="appointmentpre" class="row appointmentpre-form">
						                ...
						                <div id="input-name" class="col-lg-12">
						                	<input type="text" name="name" class="form-control name" placeholder="Introduce tu nombre*" required> 
						                </div>
						                 <!-- Form Select -->
						                <div id="input-patient" class="col-md-12 input-patient">
						                    <select id="inlineFormCustomSelect3" name="patient" class="custom-select patient" required>
						                        <option value="">¿Nos has visitado antes?*</option>
						                ...
						                <div id="input-email" class="col-md-12 col-lg-2">
						                <p>Fecha de nacimiento.
								</p></div>
						                <div id="input-nac" class="col-md-12 col-lg-6">
						                	<input type="date" name="nac" class="form-control nac" placeholder="Introduce tu fecha de nacimiento*" required> 
						                </div>
						               

						                 <div id="input-message" class="col-lg-12 input-message">
						                	<textarea class="form-control diagnosis" name="diagnosis" rows="3" placeholder="Procedimiento o estudio"></textarea>
						                </div> 

										<div id="input-genero" class="col-md-12 col-lg-6">
						                    <select id="inlineFormCustomSelect4" name="genero" class="custom-select genero" required>
						                ...
						                <div id="input-genero" class="col-md-12 col-lg-6">
						                	<input type="text" name="sangre" class="form-control sangre" placeholder="Introduce tu tipo de sangre*" required> 
						                </div>

						                <div id="input-educacion" class="col-md-12 col-lg-6">
						                    <select id="inlineFormCustomSelect5" name="educacion" class="custom-select educacion" required>
												...
												<option>Maestría o posgrado</option>
						                ...
						                <div id="input-religion" class="col-md-12 col-lg-6">
						                	<input type="text" name="religion" class="form-control religion" placeholder="Religión*" required> 
						                </div>

						               <div id="input-civil" class="col-md-12 col-lg-6">
						                    <select id="inlineFormCustomSelect6" name="civil" class="custom-select civil" required>
						                ...
						                <div id="input-prof" class="col-md-12 col-lg-6">
						                	<input type="text" name="prof" class="form-control prof" placeholder="Profesión*" required> 
						                </div>
										...
										<div id="input-ciudad" class="col-md-12 col-lg-6">
						                	<input type="text" name="ciudad" class="form-control ciudad" placeholder="Ciudad*" required> 
						                </div>
						                <div id="input-colonia" class="col-md-12 col-lg-6">
						                	<input type="text" name="colonia" class="form-control colonia" placeholder="Colonia*" required> 
						                </div>
						                <div id="input-calle" class="col-md-12 col-lg-6">
						                	<input type="text" name="calle" class="form-control calle" placeholder="Calle*" required> 
						                </div>
						                 <div id="input-numero" class="col-md-12 col-lg-6">
						                	<input type="text" name="numero" class="form-control numero" placeholder="Número*" required> 
						                </div>
 										<div id="input-cp" class="col-md-12 col-lg-6">
						                	<input type="text" name="cp" class="form-control cp" placeholder="Código postal*" required> 
						                </div>
						                 <div id="input-phone" class="col-md-12 col-lg-6">
						                	<input type="tel" name="phone" class="form-control phone" placeholder="Introduce tu número telefónico*" required> 
						                </div>
						               <div id="input-cell" class="col-md-12 col-lg-6">
						                	<input type="tel" name="cell" class="form-control cell" placeholder="Introduce tu número celular*" required> 
						                </div>
						                <div id="input-email" class="col-md-12 col-lg-6">
						                	<input type="text" name="email" class="form-control email" placeholder="Introduce tu Email*" required> 
						                </div>

						                 <div id="input-medico" class="col-lg-12">
						                	<input type="text" name="medico" class="form-control medico" placeholder="Introduce el nombre de tú médico" > 
						                </div>

						                <!-- Contact Form Input -->
						                  <div id="input-email" class="col-md-12 col-lg-3">
						                <p>Fecha probable de ingreso.
								</p>
						                </div>
						                <div id="input-date" class="col-md-12 col-lg-6">
						                	<input  type="date" name="date" class="form-control date" placeholder="Fecha posible de ingreso" required> 
						                </div>
						                ...
						                <div id="input-message" class="col-lg-12 input-message">
						                	<textarea class="form-control message" name="message" rows="2" placeholder="¿Cuenta con alguna alergia alimentaria?, favor de indicarlo"></textarea>
						                </div> 


						                <div id="input-medicamentos" class="col-lg-12 input-medicamentos">
						                	<textarea class="form-control medicamentos" name="medicamentos" rows="2" placeholder="¿Cuenta con alguna alergia a medicamentos ?, favor de indicarlo"></textarea>
						                </div> 

						                <p>En caso de requerir factura, favor de llenar los siguientes datos.
								</p>
								    <div id="input-razon" class="col-lg-12">
						                	<input type="text" name="razon" class="form-control razon" placeholder="Razón social para facturación" > 
						                </div>
						              

								 <div id="input-rfc" class="col-md-12 col-lg-6">
						                	<input type="text" name="rfc" class="form-control rfc" placeholder="Introduce tu RFC*" > 
						                </div>


									<div id="input-uso" class="col-md-12 col-lg-6">
						                    <select id="inlineFormCustomSelect7" name="uso" class="custom-select uso" >
						                ...
						                <div class="col-lg-12 form-btn">  
						                	<button type="submit" class="btn btn-blue blue-hover submit">Aceptar</button> 
						                </div>
								...
								<!-- Text -->
								<p class="p-sm grey-color mb-30">*Nota: Una vez enviados los datos, nuestro personal se pondrá en contacto con usted para confirmar la cita
								</p>
					...
					<aside id="sidebar" class="col-lg-4">
							...
							<div class="sidebar-table blue-table sidebar-div mb-50">
								...
								<!-- Title -->
								<h5 class="h5-md">Horario de laboratorio</h5>

								<!-- Text -->
								<p class="p-sm">Nuestros horarios de laboratorio son los siguientes, estamos a tús ordenes.
								</p>
								...
								<table class="table">
									<tbody>
									    <tr>
									      	<td>Lunes – Domingo</td>
									      	<td> - </td>
									      	<td class="text-right">24 horas</td>
									    </tr>
...
">Envíanos un whats app <img  src="images/whats.png" ></a><p>
						...
						<div class="col-md-6 col-lg-3">
							<div class="footer-box mb-40">
								...
								<p class="foo-email mt-20"><a href="about-us.html">Quiénes somos</a></p>
	...
	<h5 class="h2-xs blue-color"><a href="tel:4428268162" class="callusbtn"><i class="fas fa-phone"></i> 442 826 81 62</a></h5>
		...
		<script src="js/appointmentpre-form.js"></script>
